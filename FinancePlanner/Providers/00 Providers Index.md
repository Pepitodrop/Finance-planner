...
| Enable Banking / Bank AIS (preferred) | [[Enable Banking]] | Yes | Partial (directory/discovery/logos/`POST /auth` acceptance/bank-auth page all live-verified; authorization completion blocked on external bank sandbox credentials, not a code defect) | No | Partial (same split) |
