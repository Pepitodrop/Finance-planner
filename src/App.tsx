...
import { ArrowDownRight, ArrowUpRight, CalendarClock, Landmark, PiggyBank, Plus, Repeat2, Target, WalletCards } from 'lucide-react'
...
type Tab = 'dashboard' | 'transactions' | 'goals' | 'recurring'
  ...
  return (
    <div className="app-shell">
      <aside className="sidebar">
        <div className="brand"><div className="brand-mark"><Landmark size={22} /></div><div><strong>Finance Planner</strong><span>Offline-first</span></div></div>
        <nav>
        ...
        <div className="privacy-note"><strong>Lokal gespeichert</strong><span>Deine Daten bleiben in diesem Browser.</span></div>
      </aside>

      <main>
        <header className="topbar">
          <div><p className="eyebrow">Persönliche Finanzen</p><h1>{tab === 'dashboard' ? 'Finanzübersicht' : tab === 'transactions' ? 'Transaktionen' : tab === 'goals' ? 'Sparziele' : 'Wiederkehrende Zahlungen'}</h1></div>
