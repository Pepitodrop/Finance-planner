...
export function VaultGate({ children }: VaultGateProps) {
  ...
  return <main className="vault-screen">
    <section className="panel vault-card">
      ...
      <p className="muted">Konten, Transaktionen und Sparziele werden mit AES-256-GCM verschlüsselt. Der Schlüssel wird aus deinem Passwort abgeleitet und nur für diese Sitzung im Arbeitsspeicher gehalten.</p>
