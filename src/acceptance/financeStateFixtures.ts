...
/**
 * Deterministic screenshot/acceptance fixtures only.
 *
 * These values are never a production default and are only selected by the
 * acceptance harness when VITE_ACCEPTANCE_FIXTURES=true.
 */
