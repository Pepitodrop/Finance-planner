...
interface Props { state: AppState; onChange: (next: AppState) => void; initialEditorOpen?: boolean }

export function GoalsPage({ state, onChange, initialEditorOpen = false }: Props) {
  const [editor, setEditor] = useState<SavingsGoal | 'new' | null>(initialEditorOpen ? 'new' : null)
